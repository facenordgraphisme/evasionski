    ...
    <section className={`py-24 px-6 transition-colors duration-300 ${className}`}>
      <div className="container mx-auto">
        <div className="flex justify-between items-end mb-16">
          ...
          <Link href="/blog-explorez-les-hautes-alpes-a-ski" className="hidden md:block px-8 py-3 rounded-full border border-border hover:bg-foreground hover:text-background transition-all font-bold text-sm uppercase tracking-widest">
            {t('blog.viewAll')}
          </Link>
        </div>
