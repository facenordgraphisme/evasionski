      ...
      <div className="container mx-auto">
        <div className="glass rounded-[60px] p-12 md:p-24 text-center relative overflow-hidden shadow-2xl">
          ...
          <div className="relative z-10">
            ...
            <h2 className="text-4xl md:text-6xl font-light tracking-normal mb-6 text-foreground leading-tight">
            ...
            <div className="flex flex-col md:flex-row items-center justify-center gap-8">
              <Link href="/evasion-ski-hautes-alpes-contact" className="btn-primary px-12 py-5 text-lg shadow-2xl hover:scale-105 transition-transform">
                {t('contact.button')}
              </Link>
              <div className="flex flex-col items-start md:items-start text-left">
                ...
                <p className="text-2xl font-black text-foreground">06 73 45 84 34</p>
              </div>
            </div>
          </div>
        </div>
