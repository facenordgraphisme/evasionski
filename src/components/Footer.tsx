    ...
    <footer className="py-12 md:py-20 px-6 bg-background border-t border-border">
      <div className="container mx-auto">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <div className="flex gap-4">
              ...
              {settingsData?.instagram ? (
                <a href={settingsData.instagram} target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full border border-border flex items-center justify-center hover:bg-accent hover:text-white hover:border-accent transition-all">
                  <InstagramIcon />
                  <span className="sr-only">Instagram</span>
                </a>
              ) : (
                <div className="w-10 h-10 rounded-full border border-border flex items-center justify-center opacity-30">
                  <InstagramIcon />
                </div>
              )}
              ...
              {settingsData?.facebook ? (
                <a href={settingsData.facebook} target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full border border-border flex items-center justify-center hover:bg-accent hover:text-white hover:border-accent transition-all">
                  <FacebookIcon />
              ...
              {settingsData?.youtube ? (
                <a href={settingsData.youtube} target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full border border-border flex items-center justify-center hover:bg-accent hover:text-white hover:border-accent transition-all">
                  <YoutubeIcon />
        ...
        <div className="pt-8 border-t border-border">
          <div className="flex flex-col md:flex-row justify-between gap-4 text-sm text-foreground/30 font-medium mb-4">
          ...
          <div className="text-center text-sm text-foreground/30">
            {at('Propulsé par')} <a href="https://www.facenordgraphisme.fr" target="_blank" rel="noopener noreferrer" className="text-accent hover:underline font-semibold">Face Nord Graphisme</a>
          </div>
        </div>
      </div>
    </footer>
