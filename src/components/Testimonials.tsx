  ...
  const list = safeData.length > 0 ? safeData : [
    {
      ...
      quote: at("Une expérience inoubliable au sommet de la Barre des Écrins. Toni est un guide d'une sérénité absolue, ce qui est très rassurant quand on débute en haute montagne."),
      rating: 5
    },
    {
      author: "Sophie Morel",
      role: at("Passionnée de Ski"),
      quote: at("Toni nous a fait découvrir des vallons secrets du Queyras loin de la foule. Sa connaissance du terrain et de la sécurité est impressionnante. Je recommande les yeux fermés !"),
      rating: 5
    },
    {
      author: "Marc Lefebvre",
      role: at("Grimpeur"),
      quote: at("Superbe journée en grande voie à Ailefroide. Toni a su me mettre en confiance sur des passages techniques. Un vrai partage de passion et de technique."),
      rating: 5
    }
  ]
  return (
