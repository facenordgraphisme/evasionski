...
export const aLaCarteType = defineType({
  ...
  fields: [
    ...
    defineField({
      name: 'infoDuree',
      title: 'Infos pratiques — Durée',
      type: 'string',
      initialValue: 'Sur mesure',
      description: 'Texte affiché pour la durée (ex: "Sur mesure", "Flexible")',
    }),
    defineField({
      name: 'infoMassif',
      title: 'Infos pratiques — Massif',
      type: 'string',
      initialValue: 'Hautes-Alpes au choix',
      description: 'Texte affiché pour le massif',
    }),
    defineField({
      name: 'infoTarif',
      title: 'Infos pratiques — Tarif',
      type: 'string',
      initialValue: 'À partir de 400€/jour',
      description: 'Texte affiché pour le tarif',
    }),
    defineField({
      name: 'infoFlexibilite',
      title: 'Info complémentaire — Flexibilité',
      type: 'string',
      initialValue: 'Dates, durée et itinéraire personnalisables.',
      description: 'Texte pour le bloc flexibilité',
    }),
    defineField({
      name: 'infoGroupes',
      title: 'Info complémentaire — Groupes',
      type: 'string',
      initialValue: 'Seul, en famille ou entre amis (1-8 pers.).',
      description: 'Texte pour le bloc groupes',
    }),
    defineField({
      name: 'ctaText',
