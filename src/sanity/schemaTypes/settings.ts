...
export const settingsType = defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      type: 'string',
      description: 'Message par défaut envoyé lors du clic (ex: Bonjour Toni, je souhaiterais avoir des informations...)',
      group: 'contact',
    }),
    defineField({
      name: 'whatsappTextEn',
    ...
    defineField({
      ...
      title: 'Adresse email',
      type: 'string',
      initialValue: 'tonimancini05200@gmail.com',
      group: 'contact',
    }),
    defineField({
      name: 'phone',
    ...
    defineField({
      ...
      type: 'string',
      initialValue: 'Les Orres, Hautes-Alpes',
      group: 'contact',
    }),
    ...
    defineField({
      ...
      type: 'string',
      initialValue: 'ÉvasionSki. Tous droits réservés.',
      group: 'footer',
    }),
    ...
    defineField({
      ...
      type: 'string',
      description: 'Le titre du site affiché sur Google (ex: Toni Mancini - Moniteur de Ski de Randonnée Ecrins).',
      group: 'seo',
    }),
    defineField({
      name: 'seoTitleEn',
